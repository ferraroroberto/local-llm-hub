...
| `gemini-3.1-pro` (alias `gemini_pro`) | Gemini 3.1 (Google) — preview | n/a (cloud via `gemini -p`) | n/a | n/a | 1 M tokens | n/a | 8000 (hub) | n/a (AI Pro/Ultra required since 2026-03-25) | [Gemini 3.1 Pro post](https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-3-1-pro/) · [Gemini CLI](https://geminicli.com/) · [DeepMind Pro](https://deepmind.google/models/gemini/pro/) |
| `gemini-3-flash` | Gemini 3 (Google) | n/a (cloud via `gemini -p`) | n/a | n/a | per model — see docs | n/a | 8000 (hub) | n/a (subscription, Code Assist free tier) | [Gemini 3 Flash in CLI](https://developers.googleblog.com/gemini-3-flash-is-now-available-in-gemini-cli/) · [Gemini CLI quotas](https://geminicli.com/docs/resources/quota-and-pricing/) |
| `gemini-3.1-flash-lite` (alias `gemini_lite`) | Gemini 3.1 (Google) — GA 2026-05-07 | n/a (cloud via `gemini -p`) | n/a | n/a | per model — see docs | n/a | 8000 (hub) | n/a (subscription, Code Assist free tier) | [Flash-Lite GA](https://cloud.google.com/blog/products/ai-machine-learning/gemini-3-1-flash-lite-is-now-generally-available) |
...
| **gemini_pro (Google)** | `gemini-3.1-pro` | Subscription cloud route via `gemini -p`. AI Pro required for 3.1 Pro (paid since 2026-03-25). 1 M-token context. Image content blocks supported. |
| **gemini_lite (Google)** | `gemini-3.1-flash-lite` | Subscription cloud route via `gemini -p`. GA on 2026-05-07. Lowest-latency tier; quotas share with Gemini Code Assist. |
